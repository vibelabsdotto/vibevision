...
export class ScoresController {
  ...
  score(
    ...
    return {
      score: this.scores.getWeekScore(id, Number(week), {
        as_of_date: asOf,
  ...
  overall(
    ...
    return this.scores.getOverallScore(id, Number(week));
  }
  ...
  batch(
    ...
    return { scores: this.scores.getWeekScoresBatch(id, numbers) };
  }
  ...
  snapshot(
    ...
    return this.scores.captureSnapshot(id, Number(n));
  }
}
